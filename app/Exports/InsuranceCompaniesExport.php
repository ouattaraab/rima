...
class InsuranceCompaniesExport implements FromCollection, WithHeadings, WithStyles, WithColumnWidths, WithTitle, WithEvents, WithDrawings, WithCustomStartCell
{
    ...
    {
        return InsuranceCompany::orderBy('name')->get()->map(function ($item, $index) {
            return [
                $index + 1,
                $item->name,
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('B2', 'Liste des compagnies d\'assurance');
                ...
                $sheet->setCellValue("B{$totalRow}", "Total : {$dataCount} compagnie(s)");
