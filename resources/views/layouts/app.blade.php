                ...
                <div class="pt-3 mt-3 border-t border-slate-100">
                    ...
                    <div x-data="{ open: {{ request()->routeIs('referentials.*') ? 'true' : 'false' }} }">
                        ...
                        <div x-show="open" x-collapse x-cloak class="ml-7 mt-0.5 space-y-0.5 border-l border-slate-200 pl-3">
                            ...
                            <a href="{{ route('referentials.models') }}" class="block px-2 py-1.5 text-[13px] {{ request()->routeIs('referentials.models*') ? 'text-slate-900 font-medium' : 'text-slate-400 hover:text-slate-700' }}">Mod&egrave;les</a>
                            ...
                            <a href="{{ route('referentials.vehicle-types') }}" class="block px-2 py-1.5 text-[13px] {{ request()->routeIs('referentials.vehicle-types*') ? 'text-slate-900 font-medium' : 'text-slate-400 hover:text-slate-700' }}">Types v&eacute;hicule</a>
                            <a href="{{ route('referentials.vehicle-categories') }}" class="block px-2 py-1.5 text-[13px] {{ request()->routeIs('referentials.vehicle-categories*') ? 'text-slate-900 font-medium' : 'text-slate-400 hover:text-slate-700' }}">Cat&eacute;gories</a>
                    ...
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div x-show="open" @click.away="open = false" x-transition class="absolute right-0 mt-1 w-48 bg-white border border-slate-200 py-1 z-50" x-cloak>
                            ...
                            <form method="POST" action="{{ route('logout') }}">@csrf
                                <button type="submit" class="w-full text-left px-4 py-2 text-[13px] text-red-600 hover:bg-red-50/50 transition">D&eacute;connexion</button>
                            </form>
                        </div>
                    </div>
                </div>
