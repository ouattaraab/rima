    ...
    <form action="{{ route('users.store') }}" method="POST" novalidate
        x-data="{
            ...
            validate(e) {
                ...
                else if (f('password').length < 8) this.errors.password = 'Le mot de passe doit contenir au moins 8 caractères.';
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-x-12 gap-y-5 py-8 border-b border-slate-200">
            ...
            <div class="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="first_name" id="first_name" x-ref="first_name" value="{{ old('first_name') }}" placeholder="Prénom"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-x-12 gap-y-5 py-8 border-b border-slate-200">
            <div>
                ...
                <p class="text-[12px] text-slate-400 mt-1 leading-relaxed">Identifiants de connexion. Le mot de passe doit contenir au moins 8 caractères.</p>
            </div>
            <div class="lg:col-span-2 space-y-4">
                ...
                <div>
                    ...
                    <input type="password" name="password" id="password" x-ref="password" placeholder="Minimum 8 caractères"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-x-12 gap-y-5 py-8 border-b border-slate-200">
            ...
            <div class="lg:col-span-2 space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="region" id="region" value="{{ old('region') }}" placeholder="Région d'affectation"
