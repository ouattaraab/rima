        ...
        <form method="GET" action="{{ route('users.index') }}" class="flex flex-col sm:flex-row gap-3">
            ...
            <div class="flex gap-2 items-center">
                ...
                @if(request()->hasAny(['search', 'role', 'organization']))
                    <a href="{{ route('users.index') }}" class="text-[12px] text-slate-500 hover:text-slate-900 underline transition-colors">Réinitialiser</a>
                @endif
            </div>
        </form>
    </div>
        ...
        <table class="w-full text-[13px]">
            <thead>
                <tr class="border-b border-slate-200">
                    ...
                    <th class="text-left px-5 py-3 text-[11px] font-medium text-slate-400 uppercase tracking-wide border-l border-slate-200">Rôle</th>
                    ...
                    <th class="text-left px-5 py-3 text-[11px] font-medium text-slate-400 uppercase tracking-wide border-l border-slate-200">Région</th>
                    ...
                    <th class="text-left px-5 py-3 text-[11px] font-medium text-slate-400 uppercase tracking-wide border-l border-slate-200">Dernière connexion</th>
                    ...
                    <tr>
                        <td colspan="8" class="px-5 py-16 text-center">
                            <div class="flex flex-col items-center">
                                ...
                                <p class="text-[13px] font-medium text-slate-900">Aucun utilisateur trouvé</p>
