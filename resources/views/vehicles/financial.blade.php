...
@section('header', 'Donnees financieres')
     ...
     x-data="{
         ...
         validate(e) {
             ...
             if (this.mode === 'Leasing') {
                 ...
                 if (!(this.$refs.contract_number?.value || '').trim()) this.errors.contract_number = 'Le numero de contrat est obligatoire en leasing.';
             }
    ...
    <form method="POST" action="{{ route('vehicles.updateFinancial', $vehicle->id) }}" novalidate
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-x-12 gap-y-5 py-8 border-b border-slate-200">
            <div>
                ...
                <p class="text-[12px] text-slate-400 mt-1 leading-relaxed">Definit comment le vehicule a ete acquis par la SODECI.</p>
            </div>
        ...
        <div x-show="mode === 'Leasing'" x-collapse x-cloak>
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-x-12 gap-y-5 py-8 border-b border-slate-200">
                <div>
                    ...
                    <p class="text-[12px] text-slate-400 mt-1 leading-relaxed">Banque, numero de contrat et periode de prelevement du leasing.</p>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-x-12 gap-y-5 py-8 border-b border-slate-200">
            <div>
                ...
                <p class="text-[12px] text-slate-400 mt-1 leading-relaxed">Date de debut du contrat et date de mise a disposition du vehicule.</p>
            </div>
