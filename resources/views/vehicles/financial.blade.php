    ...
    <form method="POST" action="{{ route('vehicles.updateFinancial', $vehicle->id) }}" novalidate
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-x-12 gap-y-5 py-8 border-b border-slate-200">
            <div>
                ...
                <p class="text-[12px] text-slate-400 mt-1 leading-relaxed">Code d'immobilisation du véhicule (7 chiffres).</p>
            </div>
            <div class="lg:col-span-2">
                <div>
                    <label for="code_immo" class="block text-[11px] font-medium text-slate-400 uppercase tracking-wide mb-1.5">Code IMMO <span class="text-red-500">*</span></label>
